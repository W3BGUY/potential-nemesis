...
def link_by_id(link_id):
    #return link_index[link_id] <- This will work if the index exists, but will crash if not
    return link_index.get(link_id)  # <- This will return none if the index does not exist.
