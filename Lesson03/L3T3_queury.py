...
def query():
    ...
    rLinks.sort(key=lambda tup: tup[2])
    #rlinks.sort(key=lambda x: x.submitted_time)  <= instructor code
    return rLinks

#print query()
# ->    [Link(id=15, submitter_id=62443, submitted_time=1333900877.0, votes=1244, title="Why vector icons don't work", url='http://www.pushing-pixels.org/2011/11/04/about-those-vector-icons.html'),
#       Link(id=18, submitter_id=62443, submitted_time=1333939389.0, votes=104, title='github is making me feel stupid(er)', url='http://www.serpentine.com/blog/2012/04/08/github-is-making-me-feel-stupider/'),
#       Link(id=101, submitter_id=62443, submitted_time=1334018620.0, votes=4, title='research!rsc: Zip Files All The Way Down', url='http://research.swtch.com/zip')]
